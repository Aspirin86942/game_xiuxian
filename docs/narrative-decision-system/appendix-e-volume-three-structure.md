# 附录 E. 改编第三卷《魔道入侵》结构草案

## 1. 目的

本附录用于把改编第三卷《魔道入侵》的目标结构固定下来，避免 issue #10 提到的“试炼、战争、阵营冲突与南宫婉线正式起势”继续只停在 issue 或聊天里。
...
- 当前 `21 初入星海`、`22 虚天残图`、`23 星海飞驰 / 来信与重访` 继续作为后续卷入口资产保留；其中 `24 重返天南` 与 `25 化神飞升` 后续由改编第五卷《归乡飞升》正式接管。
