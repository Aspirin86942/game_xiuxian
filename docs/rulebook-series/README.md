...
- 当前已成熟分册：`narrative-decision-system`、`inventory-and-item-system`
...
3. 若当前任务偏剧情选择，按 `narrative-decision-system` 的 `00 -> 01 -> 02 -> 03 -> 04 -> 05` 顺序阅读。
4. 若当前任务偏储物、消费、可使用物品，按 `inventory-and-item-system` 的 `00 -> 01 -> 02 -> 03 -> 04 -> 05` 顺序阅读。
5. 最后回到本索引，核对分册边界、成熟度与同步规则。
