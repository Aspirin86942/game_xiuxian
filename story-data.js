(function (globalScope) {
    ...
    const LOCATION_COMMISSIONS_V1 = Object.freeze([
        ...
        {
            id: 'huangfeng_pill_furnace',
            title: '丹房废炉',
            boardLabel: '山门差使',
            category: '丹房',
            location: '黄枫谷',
            visibleLocations: COMMISSION_BOARD_LOCATION_ALIASES['黄枫谷'],
            minRealmScore: 4,
            maxRealmScore: 6,
            detail: '值守弟子把一炉半废丹炼炸了，不敢直接报上去，想托你先把残局理清。',
            rewardPreview: '灵石 x10 · 解毒散 x1',
            choices: [
                {
                    id: 'report_by_rule',
                    text: '按门规上报，把废炉与残丹一并交清',
                    resultState: 'completed',
                    effects: {
                        items: { lingshi: 10, jiedusan: 1 },
                        routeScores: { orthodox: 1 },
                        flags: { huangfengPillFurnaceReported: true },
                    },
                    resultSummary: '你按门规把废炉和残丹一并报了上去。',
                    resultDetail: '这笔差使办得不近人情，却让丹房以后再难把责任含糊过去。',
                },
                {
                    id: 'cover_for_disciple',
                    text: '替值守弟子先把废炉遮过去',
                    resultState: 'completed',
                    effects: {
                        items: { lingshi: 12, lingcao: 1 },
                        routeScores: { secluded: 1 },
                        flags: { huangfengPillFurnaceCovered: true },
                    },
                    resultSummary: '你先替人把废炉压住，让这桩差使没立刻闹到执事面前。',
                    resultDetail: '丹房那名弟子记住了你的人情，但门里并不会因此少一道账。',
                },
            ],
        },
        {
            id: 'huangfeng_stolen_herbs',
            title: '药园失窃',
            boardLabel: '山门差使',
            category: '药园',
            location: '黄枫谷',
            ...
            minRealmScore: 4,
            maxRealmScore: 6,
            detail: '药园少了几株将熟灵草，守园弟子怕担责，想先把偷拿的人找出来。',
            rewardPreview: '灵石 x11 · 灵草 x2',
            choices: [
                {
                    id: 'trace_by_roster',
                    text: '按轮值和出入牌逐一查人',
                    ...
                    effects: {
                        ...
                        routeScores: { orthodox: 1 },
                        flags: { huangfengHerbTheftTraced: true },
                    },
                    resultSummary: '你顺着轮值和出入牌把偷拿灵草的人查了出来。',
                    resultDetail: '药园少了几分人情，多了几分规矩，但这正是山门会记住你的地方。',
                },
                {
                    id: 'hide_the_gap',
                    ...
                    effects: {
                        routeScores: { demonic: 1 },
                        flags: { huangfengHerbGapCovered: true },
                    },
                    resultSummary: '你想把缺口先补平，结果新旧账一起缠上了你。',
                    resultDetail: '这笔差使没办妥，药园只多了一层更说不清的阴影。',
                },
            ],
        },
        {
            id: 'huangfeng_outer_mountain_patrol',
            title: '外山巡查',
            boardLabel: '山门差使',
            category: '巡查',
            location: '黄枫谷',
            ...
            minRealmScore: 4,
            maxRealmScore: 6,
            detail: '一名外派弟子迟迟未回，执事想让你去外山看一眼是人失了路还是事出了岔。',
            rewardPreview: '灵石 x12 · 妖丹 x1',
            choices: [
                {
                    ...
                    effects: {
                        ...
                        routeScores: { secluded: 1 },
                        flags: { huangfengPatrolReturnedCleanly: true },
                    },
                    resultSummary: '你查清外山踪迹后便及时回谷，把该交的消息完整交回。',
                    resultDetail: '差使办得利落，也让门里人看见你知道什么时候该往回收。',
                },
                {
                    ...
                    effects: {
                        routeScores: { demonic: 1 },
                        flags: { huangfengPatrolOverpressed: true },
                    },
                    resultSummary: '你想独自把线索追到底，反而在外山白白折了一圈。',
                    resultDetail: '这笔差使失了手，门里只会记得你越过了该守的分寸。',
                },
            ],
        },
        {
            id: 'huangfeng_warehouse_ledger',
            title: '库房错账',
            boardLabel: '山门差使',
            category: '库房',
            location: '黄枫谷',
            ...
            minRealmScore: 4,
            maxRealmScore: 6,
            detail: '库房灵材账目对不上，有人想赶在交接前把账先补圆。',
            rewardPreview: '灵石 x13 · 灵草 x1',
            choices: [
                {
                    id: 'audit_openly',
                    text: '按账册与库签重核一遍',
                    ...
                    effects: {
                        ...
                        routeScores: { orthodox: 1 },
                        flags: { huangfengWarehouseAudited: true },
                    },
                    resultSummary: '你把库签、账册和交接单一并对清，缺口终于落到了实处。',
                    resultDetail: '这不是好看的差使，却是山门最认真的那一种苦功。',
                },
                {
                    ...
                    effects: {
                        items: { lingshi: 14 },
                        routeScores: { secluded: 1 },
                        flags: { huangfengWarehousePatched: true },
                    },
                    resultSummary: '你先把账补圆，替交接的人把最难看的那一页翻了过去。',
                    resultDetail: '差使算是收住了，只是门里真正的缺口并没有因此消失。',
                },
            ],
        },
        {
            id: 'starsea_lost_ship',
            title: '海雾失船',
            boardLabel: '海上委托',
            category: '探船',
            location: '乱星海',
            visibleLocations: COMMISSION_BOARD_LOCATION_ALIASES['乱星海'],
            minRealmScore: 7,
            maxRealmScore: 10,
            detail: '一艘小船在海雾里失了回音，有人愿出高价请你先去把海路与生死探明。',
            rewardPreview: '灵石 x16 · 妖丹 x1',
            choices: [
                {
                    ...
                    effects: {
                        ...
                        routeScores: { secluded: 1 },
                        flags: { starseaLostShipChartSaved: true },
                    },
                    resultSummary: '你先保住退路和海图，把这趟探船做成了一笔能交代的活。',
                    resultDetail: '在乱星海，能活着带回清楚消息，本身就比硬逞一口气更值钱。',
                },
                {
                    id: 'push_into_fog',
                    text: '不退半步，继续压进海雾最深处',
                    ...
                    effects: {
                        routeScores: { demonic: 1 },
                        flags: { starseaLostShipFogOverpressed: true },
                    },
                    resultSummary: '你一意压进海雾深处，最后连原本能带回的路标都丢了。',
                    resultDetail: '这笔委托没办成，海上只会记得你差点把自己也折进那团雾里。',
                },
            ],
        },
        {
            id: 'starsea_demon_tide',
            title: '猎妖引潮',
            boardLabel: '海上委托',
            category: '猎妖',
            location: '乱星海',
            ...
            minRealmScore: 7,
            maxRealmScore: 10,
            detail: '有人悬赏附近海域的妖兽材料，但那片海潮正乱，收手太慢就会被潮头卷住。',
            rewardPreview: '灵石 x18 · 妖丹 x2',
            choices: [
                {
                    id: 'take_clean_hunt',
                    text: '只取最稳的一份材料，见好便收',
                    ...
                    effects: {
                        ...
                        routeScores: { orthodox: 1 },
                        flags: { starseaDemonTideTakenClean: true },
                    },
                    resultSummary: '你只取了最稳的那份妖材，在潮头真正翻脸前便收了手。',
                    resultDetail: '海上最难的不是出手，而是知道哪一刀之后必须立刻转身。',
                },
                {
                    ...
                    effects: {
                        routeScores: { demonic: 1 },
                        flags: { starseaDemonTideOverstayed: true },
                    },
                    resultSummary: '你想趁乱多取一枚妖丹，结果差点被反卷回海心。',
                    resultDetail: '这笔委托最后没能完整交差，海上人人都知道你多贪了那一步。',
                },
            ],
        },
        {
            id: 'starsea_black_market_transfer',
            title: '黑市转运',
            boardLabel: '海上委托',
            category: '转运',
            location: '乱星海',
            ...
            minRealmScore: 7,
            maxRealmScore: 10,
            detail: '黑市商人托你转运一批不便见光的货，只说按时送到，别多问来路。',
            rewardPreview: '灵石 x17 · 灵草 x2',
            choices: [
                {
                    id: 'deliver_sealed',
                    text: '按约封箱送达，不看不问',
                    ...
                    effects: {
                        ...
                        routeScores: { secluded: 1 },
                        flags: { starseaBlackMarketDelivered: true },
                    },
                    resultSummary: '你按时把封箱送到，海上的人也按海上的规矩付了钱。',
                    resultDetail: '有些差使值钱，正因为每个人都默认不把箱盖掀起来。',
                },
                {
                    id: 'inspect_manifest',
                    ...
                    effects: {
                        ...
                        routeScores: { orthodox: 1 },
                        flags: { starseaBlackMarketInspected: true },
                    },
                    resultSummary: '你先验了货，再把能送的那部分送了出去。',
                    resultDetail: '少赚了一些，却也没把自己完全卖给海上的黑账。',
                },
            ],
        },
        {
            id: 'starsea_broken_formation',
            title: '孤岛残阵',
            boardLabel: '海上委托',
            category: '试阵',
            location: '乱星海',
            ...
            minRealmScore: 7,
            maxRealmScore: 10,
            detail: '几名散修想请你一起试探一处孤岛残阵，但每个人都明显先给自己留了退路。',
            rewardPreview: '灵石 x15 · 解毒散 x2',
            choices: [
                {
                    ...
                    effects: {
                        ...
                        routeScores: { orthodox: 1 },
                        flags: { starseaBrokenFormationMarked: true },
                    },
                    resultSummary: '你先把退路标清，再与那几名散修把阵外与阵内的分寸说死。',
                    resultDetail: '这笔委托办成了，靠的不是谁真讲义气，而是你先把退路写在了前头。',
                },
                {
                    id: 'rush_core_eye',
                    ...
                    effects: {
                        routeScores: { demonic: 1 },
                        flags: { starseaBrokenFormationRushed: true },
                    },
                    resultSummary: '你抢先扑向阵眼，结果残阵翻卷，把整趟试阵都掀乱了。',
                    resultDetail: '这笔委托没收住，海上同伴更不会给第二次毫无防备的信任。',
                },
            ],
        },
    ]);
