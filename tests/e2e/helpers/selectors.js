...
module.exports = {
    ...
    journey: {
        ...
        npcs: '#location-npcs',
        commissions: '#side-story-list',
        commissionCard: (commissionId) => `#side-story-list [data-commission-id="${commissionId}"]`,
        commissionStatus: (commissionId) => `#side-story-list [data-commission-id="${commissionId}"] .side-story-status`,
        commissionAccept: (commissionId) => `#side-story-list [data-commission-id="${commissionId}"] [data-commission-action="accept"]`,
        commissionChoice: (commissionId, choiceId) => `#side-story-list [data-commission-id="${commissionId}"] [data-commission-choice-id="${choiceId}"]`,
    },
    inventory: {
